...
export function GroomCard() {
  return (
    ...
    >
      ...
      {/* Groom Image Frame */}
      <CoupleImage alt="Groom" initials="S.H." className="mb-6" />
      ...
      <p className="font-sans text-xs sm:text-sm text-[#766E65] leading-relaxed max-w-sm mb-6">
        An adventurous architect who finds beauty in structure and stories. Sebastian inspires with his gentle strength, kind humor, and unwavering devotion.
      </p>
